    ...
    return (
        <>
            ...
            <Text>
                ...
                <ol>
                    <li>How would you describe your current Meditation Practice, in terms of Dedication and Frequency on a scale of 0 to 10?<br /><em>(0 being non-existent and 10 being it is an inherent part of who you are).</em></li>
                    <li>How Easeful is your meditation practice, in terms of Focus and Enjoyment?<br /><em>(0 difficulty in staying focused and still and 10 easily dropping into connection).</em></li>
                    <li>How much Benefit are you getting from meditation?<br /><em>(0 it causes stress and I am in my head efforting, 10 it brings me to a place of centered calm).</em></li>
                </ol>
            </Text>
        </>
    )
