...
const Bowen = props => {
    return (
        <>
            <Text title="Bowen Therapy">
                <p>
                    Bowen is a relaxing, gentle and potentially powerful Holistic Therapy understanding that each part of our being connects to and influences another.
                </p>
                <p>
            ...
            <Quote color='green'>
                <p>
                    I believe that we are each responsible for taking care of our own health, growth and being. And I recognise that sometimes life brings things up for us; processes from which we can learn and grow, but which can be difficult to navigate. In such times we sometimes feel a pull to reach out for help and honour ourselves through doing that.
                </p>
            </Quote>
            <Text>
                <p>
                    Some people use Bowen Therapy to treat physical conditions and imbalances, which is great.
                </p>
                <p>
